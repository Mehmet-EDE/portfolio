...
function About() {
  return (
    <div className='w-full h-screen flex items-center justify-around relative rsm:flex-wrap rsm:mt-40'>
      <p className='flex w-fit text-3xl text-white  text-center absolute rsm:mt-96 items-start left-[10rem] mt-32 -top-10 rsm:-top-36 self-center rsm:left-0 ' >My Projects </p>
      <br />
